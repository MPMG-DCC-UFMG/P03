...
# df = pd.read_csv('licitacoes/licitacoes-obras.csv')
# for i, item in df.iterrows():
#     f = open('diarios-conteudo/'+str(i)+'.txt', 'w')
#     f.write(str(item['conteudo']))
#     f.close()
# exit()
...
# java -cp mp-ufmg-ner.jar:lib/* Pipeline ../../indexer/indices-sample/diarios-conteudo ../../indexer/indices-sample/diarios-conteudo-ent
...
print(df)
df.to_csv('licitacoes/licitacoes-obras-entidades2.csv', index=False)